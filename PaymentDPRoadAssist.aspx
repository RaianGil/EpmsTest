<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaymentDPRoadAssist.aspx.cs" Inherits="EPolicy.PaymentDP" %>
                        ...
                        <div class="row formWraper">
                            <div class="form col-sm-12">
                                <div class="row generalSearch">
                                    ...
                                    <label><h4><asp:Literal ID="lblTermsTitle" runat="server" >Términos  y Condiciones de Pago</asp:Literal></h4></label>
                                    <br />
                                     <asp:CheckBox ID="chkTermino" runat="server" AutoPostBack="false"  Text=""  Visible="true" />
 	                                    <asp:Label ID="lblTerms" runat="server" Class="" Font-Bold="False">He leído y estoy de acuerdo con los términos del negocio , los términos del financiamiento, y los términos de pago . Si seleccioné el método de pagos mensuales, entiendo y estoy de acuerdo que se debitará automáticamente del método de pago que seleccioné. Entiendo que el método de pago que seleccioné puedo cambiarlo en cualquier momento sin incurrir costos adicionales. </asp:Label>
                                          <br />
                                           <br />
                                        ...
                                        <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="UpdatePanel1"
                                            ...
                                            <ProgressTemplate>
                                                <img alt="" src="Images2/loader.gif" style="width: 40px; height: 40px;" />
                                                 <asp:Label id="lblwait" runat="server" Class="" Font-Bold="False" 
                                                    CssClass="style1">Favor de Esperar...</asp:Label>
                                                </ProgressTemplate>
                                        </asp:UpdateProgress>
                                        </div>
                                    </div>
