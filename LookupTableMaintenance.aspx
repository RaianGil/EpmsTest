...
<body>
<form id="LookupTable" method="post" runat="server">
                    ...
                    <div class="col-sm-9 col-md-10 main" style="height: 100%">
                        ...
                        <h1 class="page-header">
                         ...
                         <div class="form=group" align="center">
                            <asp:Button id="btnLookupTableMetadata" runat="server" Text="LOOKUP TABLE" onclick="btnLookupTableMetadata_Click"  Width="200px" CssClass="btn btn-primary btn-lg"></asp:Button>
                            <br />
                            <br />
                            <div align="left">
                             <asp:Label id="lblProspectNo" runat="server" CssClass="labelForControl" Font-Bold="True">Total Number of Tables:</asp:Label>
					<asp:Label id="lblTotalTables" runat="server" Font-Bold="True"></asp:Label>
                      </div>
                        </div>
                         <div class="form-group" align="center">
...
<asp:Label id="LblError" runat="server" ForeColor="Red"  Visible="False">Label</asp:Label>
                            ...
                            <div class="table-responsive">
                                        <asp:datagrid id="grdDisplayTables"  RUNAT="server" CssClass="table table-striped" 
												...
												ALTERNATINGITEMSTYLE-BACKCOLOR="#FEFBF6" ALTERNATINGITEMSTYLE-CSSCLASS="HeadForm3" CELLPADDING="0" 
                                                    ALLOWPAGING="True" AUTOGENERATECOLUMNS="False" Font-Bold="True" Font-Size="14px" BorderColor="Transparent"  PageSize="15"
												HEADERSTYLE-HORIZONTALALIGN="Center" ITEMSTYLE-HORIZONTALALIGN="center" Width="80%">
                                            ...
                                            <HeaderStyle BackColor="Gray" ForeColor="White" Height="30px" HorizontalAlign="Left"
                                                Font-Bold="True" />
												<Columns>
													  <asp:ButtonColumn ButtonType="LinkButton" HeaderStyle-HorizontalAlign="Center" CommandName="Edit" Text="&lt;img src='images2/searchGrid.png' width='26px' height='30px' &gt;"
                                                    HeaderText="Select">
