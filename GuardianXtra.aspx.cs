...
namespace EPolicy
{
    public partial class GuardianXtra : System.Web.UI.Page
    {
        ...
        /// <summary>
        /// Fills HTML Controls with DataBase Information
        /// </summary>
        private void FillTextControl()
        {
            ...
            ddlOriginatedAt.SelectedIndex = ddlOriginatedAt.Items.IndexOf(
                    ddlOriginatedAt.Items.FindByValue("207"));
            ...
            txtVehicleVIN.Text = taskControl.XtraVIN;
            txtVehiclePlate.Text = taskControl.XtraPlate;
        ...
        public void DisableControls()
        {
            ...
            //btnNew.Visible = true;
                if (btnPrintInvoice.Visible == true)
            ...
            //}
                ...
                chkIsPersonalAuto.Visible = true;
                chkIsCommercialAuto.Visible = true;
                chkIsCommercialAuto.Enabled = false;
                ChkAutoAssignPolicy.Enabled = false;

                chkHasAccident12.Visible = true;
                ...
                rdbCoverageNo.Visible = true;
                rdbCoverageYes.Visible = true;
        ...
        private DataTable GetXtraAutoByTaskControlID(int TaskControlID)
        {
            try
            {
                ...
                try
                {
                    dt = exec.GetQuery("GetAutoGuardianXtraByTaskControlID", xmlDoc);
                    return dt;
                }
                catch (Exception ex)
                {
        ...
        private void PrintAfterPay()
        {
            try
            {
               ...
               // EPolicy.TaskControl.RoadAssistance taskControl = (EPolicy.TaskControl.RoadAssistance)Session["TaskControl"];
                ...
                GetXtraFileTableAdapters.GetXtraFileTableAdapter ds = new GetXtraFileTableAdapters.GetXtraFileTableAdapter();
                ReportDataSource rpd = new ReportDataSource("GetXtraFile", (DataTable)ds.GetData(taskControl.TaskControlID));
                ...
                if (LookupTables.LookupTables.GetDescription("Location", Login.Login.GetLocationByUserID(cp.UserID).ToString()).Contains("THOMAS"))
                {
                    ...
                    viewer.LocalReport.ReportPath = PathReport + "RoadAssistXtra.rdlc";
                ...
                DataTable dt = taskControl.GuardianXtraCollection;

                if (taskControl.GuardianXtraCollection.Rows.Count == 2)
                {
                    if (LookupTables.LookupTables.GetDescription("Location", Login.Login.GetLocationByUserID(cp.UserID).ToString()).Contains("THOMAS"))
                    {
        ...
        protected void BtnCashPayment_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SendEmail(CustomerName, taskControl.Customer.Email.ToString(), PaymentMethod, PaymentType, taskControl.TotalPremium.ToString(), "", EntryDate, taskControl.PolicyType.Trim() + taskControl.PolicyNo, DebitDate);
        ...
        private void SendEmail(string CustomerName, string Email, string PaymentMethod, string PaymentType, string PaymentAmount, string AccNumber, string EntryDate, string PolicyNumber, string DebitDate)
        {
            try
            {
                ...
                SM.IsBodyHtml = true;
                SM.Attachments.Add(new Attachment(@"F:\inetpub\wwwroot\Epms\ExportFiles\" + pdf));
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
         {
            ...
            try
            {
                ...
                taskControl = (EPolicy.TaskControl.GuardianXtra)EPolicy.TaskControl.TaskControl.GetTaskControlByTaskControlID(taskControl.TaskControlID, userID);
        ...
        private void ValidateFields()
        {
            ...
            try
            {
                ...
                {
                    if (!cp.IsInRole("GUARDIAN XTRA RETRO EFFDATE") && !cp.IsInRole("ADMINISTRATOR"))
                    {
        ...
        private void FillProperties()
        {
            ...
            taskControl.XtraIsCreditPayment = chkCredit.Checked;
            ...
            {
                taskControl.XtraVehicleMakeID = int.Parse(ddlVehicleMake.SelectedItem.Value);
            }
            else
            {
            ...
            taskControl.XtraVehicleModelID = ddlVehicleModel.SelectedItem.Value == "" ? 0 : int.Parse(ddlVehicleMake.SelectedItem.Value);
        ...
        private void EnableControls()
        {
            ...
            if (cp.IsInRole("ADMINISTRATOR") || cp.IsInRole("GUARDIAN CENTRAL OFFICE"))
                ddlAgent.Enabled = true;
            else
                ddlAgent.Enabled = false;
        ...
        {
            Session.Clear();
            EPolicy.TaskControl.GuardianXtra taskControl = new EPolicy.TaskControl.GuardianXtra();
        ...
        public List<string> ImprimirRoadAssistance(List<string> mergePaths, EPolicy.TaskControl.GuardianXtra taskControl, string Copy)
        {
            ...
            try
            {
                ...
                switch (e.CommandName)
                {
                    case "Select":
                        ...
                        if (i != 0)
                        {
                            EPolicy.TaskControl.GuardianXtra opp = (EPolicy.TaskControl.GuardianXtra)EPolicy.TaskControl.TaskControl.GetTaskControlByTaskControlID(i, userID);
                    ...
                    case "Apply":
                        ...
                        EPolicy.TaskControl.GuardianXtra newOPP = (EPolicy.TaskControl.GuardianXtra)EPolicy.TaskControl.TaskControl.GetTaskControlByTaskControlID(a, userID);
                    ...
                    case "Print":
                        ...
                        EPolicy.TaskControl.GuardianXtra taskControl2 = (EPolicy.TaskControl.GuardianXtra)Session["TaskControl"];

                        int s = int.Parse(e.Item.Cells[2].Text);
                        string comments = e.Item.Cells[10].Text.Trim();
                        EPolicy.TaskControl.GuardianXtra newOPP2 = (EPolicy.TaskControl.GuardianXtra)EPolicy.TaskControl.TaskControl.GetTaskControlByTaskControlID(s, userID);
        ...
        protected void btnRenew_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                TaskControl.GuardianXtra taskControl = new TaskControl.GuardianXtra();  //Policy
                TaskControl.GuardianXtra GuardianXtra = (TaskControl.GuardianXtra)Session["TaskControl"];

                
                EPolicy.TaskControl.GuardianXtra taskControlEndo = null;
                ...
                taskControl.Mode = 1;
                taskControl.TaskControlTypeID = 27; // Guardian Xtra
                ...
                taskControl.AutoAssignPolicy = false;
                taskControl.XtraVIN = txtVehicleVIN.Text.ToString().Trim();
                taskControl.XtraPlate = txtVehiclePlate.Text.ToString().Trim();
        ...
        protected void btnAddVehicle_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    taskControl.GuardianXtraCollection.Rows.RemoveAt(int.Parse(txtIDRoadAssist.Text));
                    taskControl.GuardianXtraCollection.AcceptChanges();
                }

                DataTable dt = null;
                DataRow myRow = taskControl.GuardianXtraCollection.NewRow();
                ...
                myRow["NewUse"] = ddlNewUsed.SelectedItem.Value.Trim();
                myRow["NewUseDesc"] = EPolicy.LookupTables.LookupTables.GetDescription("NewUse", ddlNewUsed.SelectedItem.Value.Trim());
                myRow["Plate"] = txtVehiclePlate.Text.Trim();
                myRow["HasCoverageExplain"] = TxtExplain.Text.Trim();

                if (VerificarAutos(taskControl.GuardianXtraCollection))
                {
                    myRow["Premium"] = 25.0;
                }
                else
                ...
                taskControl.GuardianXtraCollection.Rows.Add(myRow);
                taskControl.GuardianXtraCollection.AcceptChanges();

                dt = taskControl.GuardianXtraCollection;
        ...
        protected void btnGuardianPay_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                EncryptClass.EncryptClass encrypt = new EncryptClass.EncryptClass();
                Response.Redirect("PaymentDP.aspx?id=" + encrypt.Encrypt(taskControl.TaskControlID.ToString()), false);
            }
            catch (Exception ex)
            {
                //throw new Exception(ex.Message);
        ...
        public void PolicyXML(int TaskControlID)
        {
            try
            {
                    ...
                    while (rdr.Read())
                    {
                        ...
                        DataTable DtCommision = GetCommissionAgentRateByCarsID("178","23", TaskControlID.ToString());
        ...
        public void XMLInsert(string xmlString, int TaskControlID)
        {
            try
            {
                ...
                foreach (XmlNode XmlPolicyBase in XmlBase)
                {
                    ...
                    UpdatePolicyFromPPSByTaskControlID(TaskControlID, PolicyNumber.Replace("XPA", "").Replace("XCA", ""), ClientID);
                    ...
                    taskControl.PolicyNo = int.Parse(PolicyNumber).ToString("");//int.Parse(PolicyNumber).ToString("0000000");
                    Session["TaskControl"] = taskControl;
        ...
        private static DataTable GetCommissionAgentRateByCarsID(string CarsID, string PolicyClassID, string TaskControlID)
        {
            DbRequestXmlCookRequestItem[] cookItems =
            ...
            try
            {
                dt = exec.GetQuery("GetCommissionAgentRateByCarsID", xmlDoc);
                return dt;
            }
            catch (Exception ex)
            {
