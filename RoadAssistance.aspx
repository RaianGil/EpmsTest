<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RoadAssistance.aspx.cs" Inherits="EPolicy.RoadAssistance" %>
                    ...
                    <div class="col-sm-9 col-md-10 main" style="height: 100%">
                        ...
                        <div class="form=group" align="center">
                            ...
                            <asp:Button ID="btnPrintPolicy" runat="server" CssClass="btn btn-primary btn-lg"
                                OnClick="BtnPrint_Click" TabIndex="78" Text="PRINT" 
                            ...
                            <br />
                            <div align="left">
                                <asp:Label ID="Label8" runat="server" Font-Bold="True" ForeColor="Gray">Guardian Road Assist:</asp:Label>
                                    ...
                                    <Toolkit:AccordionPane ID="AccordionPane1" runat="server">
                                        ...
                                        <Content>
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <br />
                                                <asp:TextBox ID="TxtSocialSec" TabIndex="1005" runat="server" CssClass="form-controlWhite" Width="200px" MaxLength="9"></asp:TextBox>
                                                ...
                                                <br />
                                                <br />
                                                <asp:Label ID="lblLicense" runat="server" Visible="false" CssClass="labelForControl" ForeColor="Red">License Num.</asp:Label>
                                                <br />
                                                <asp:TextBox ID="TxtLicense" runat="server" Visible="false" CssClass="form-controlWhite" MaxLength="7"
                                                ...
                                                <br />
                                                <asp:TextBox ID="TxtOccupa" runat="server" Visible="false" CssClass="form-controlWhite" Style="text-transform: uppercase"
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <br />
                                                 <asp:DropDownList ID="ddlState" runat="server" AutoPostBack="True" CssClass="form-controlWhite"
                                                   OnSelectedIndexChanged="ddlState_SelectedIndexChanged"   TabIndex="1015">
                                                </asp:DropDownList>
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <br />
                                                <asp:DropDownList ID="ddlState2" runat="server" AutoPostBack="True" CssClass="form-controlWhite"
                                                     OnSelectedIndexChanged="ddlState2_SelectedIndexChanged" TabIndex="1015">
                                                     </asp:DropDownList>
                                    ...
                                    <Toolkit:AccordionPane ID="AccordionPane2" runat="server" TabIndex="1999">
                                        ...
                                        <Content>
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <br />
                                                <asp:TextBox ID="TxtTerm" runat="server" CssClass="form-controlWhite" MaxLength="3" TabIndex="2003"></asp:TextBox>

                                                <br />
                                                <br />
                                                <asp:Label ID="lblSuffix" Visible="false" runat="server" CssClass="labelForControl" Width="34px">Suffix</asp:Label>
                                              
                                                <br />
                                                <asp:TextBox ID="TxtSufijo"  Visible="false"  runat="server" CssClass="form-controlWhite" MaxLength="2" TabIndex="2002"></asp:TextBox>
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <br />
                                                <br />
                                                <asp:Label ID="Label64" runat="server"  Visible="false" CssClass="labelForControl" ForeColor="Red">Deducible</asp:Label>
                                                <br />
                                                <asp:DropDownList ID="ddlDeducible" runat="server" Visible="false" AutoPostBack="True" CssClass="form-controlWhite"
                                                ...
                                                <br />
                                                <asp:TextBox ID="txtPremium" runat="server" CssClass="form-controlWhite" Enabled="true"
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <br />
                                                <asp:DropDownList ID="ddlAgent" runat="server" CssClass="form-controlWhite" TabIndex="2012"  Width="250px">
                                                </asp:DropDownList>
                                                <br />
                                                <br />
                                    ...
                                    <Toolkit:AccordionPane ID="AccordionPane3" runat="server">
                                        ...
                                        <div style="width:100%">
                                         <asp:CheckBox ID="chkIsCommercialAuto" runat="server" AutoPostBack="True" Font-Bold="True"
                                                    ...
                                                    TabIndex="3000" visible="false" Text="Is Commercial Auto" />
                                          &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                                  <asp:CheckBox ID="chkIsPersonalAuto" runat="server" AutoPostBack="True" Checked="True"
                                                    Font-Bold="True" OnCheckedChanged="chkIsPersonalAuto_CheckedChanged" visible="false" TabIndex="3001"
                                                    Text="Is Personal Auto" />
                                        &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                                  <asp:CheckBox ID="chkHasAccident12" runat="server" AutoPostBack="True" visible="false" Checked="False"
                                           ...
                                           <div class="col-sm-1">
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <asp:Label ID="lblDealer0" runat="server" CssClass="labelForControl">VIN</asp:Label>
                                                <br />
                                                ...
                                                <br />
                                                <br />
                                                <asp:Label ID="lblCoverage" Visible="false" runat="server" CssClass="labelForControl">
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                                Does this vehicle have another coverage?</asp:Label>
                                                <br />
                                                <asp:RadioButton ID="rdbCoverageYes"  Visible="false"  runat="server" AutoPostBack="True" GroupName="chkcoverage"
                                                    OnCheckedChanged="rdbCoverageYes_CheckedChanged" TabIndex="3008" Text="Yes" />
                                                    &nbsp;&nbsp;
                                                <asp:RadioButton ID="rdbCoverageNo"  Visible="false"  runat="server" AutoPostBack="True" Checked="True"
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <asp:DropDownList ID="ddlNewUsed" runat="server" CssClass="form-controlWhite" TabIndex="3007"
                                                    Visible="False" Width="125px">
                                                        ...
                                                        <div class="col-sm-2">
                                                        <br />
                                                <asp:Button ID="btnAddVehicle" runat="server" AutoPostBack="True" CssClass="btn btn-primary btn-lg" Font-Bold="True"
                                                    ForeColor="White" Height="39px" OnClick="btnAddVehicle_Click" TabIndex="3006"
                                                    Text="Add" Visible="true" Width="120px"  Font-Size="Larger" />
                                                    </div>
                                                ...
                                                <asp:GridView ID="GridVehicle" runat="server" AutoGenerateColumns="False" BorderColor="Black"
                                                    ...
                                                    onrowcommand="GridVehicle_RowCommand"  Font-Bold="False"  DataKeyNames="VehicleYear,VehicleMake,VehicleModel,VIN,Plate,TaskControlID,VehicleMakeID,VehicleModelID,VehicleYearID,AsistenciaCarreteraAutoID,NewUse" 
                                                    Width="85%" HeaderStyle-HorizontalAlign="Center" Font-Size="10px" OnRowDeleting="GridVehicle_RowDeleting">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="Plate" HeaderText="License Plate #" ReadOnly="True"
                                                            SortExpression="LicensePlateNo" />
                                                        
                                                        <asp:BoundField DataField="TaskControlID" HeaderText="TaskControlID" Visible="False" /> 
                                                        <asp:BoundField DataField="VehicleMakeID" HeaderText="VehicleMakeID" Visible="False" /> 
                                                        <asp:BoundField DataField="VehicleModelID" HeaderText="VehicleModelID" Visible="False" /> 
                                                        <asp:BoundField DataField="VehicleYearID" HeaderText="VehicleYearID" Visible="False" /> 
                                                        <asp:BoundField DataField="AsistenciaCarreteraAutoID" HeaderText="AsistenciaCarreteraAutoID" Visible="False" /> 
                                        ...
                                        <Content>
                                         <div class="col-sm-1">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                                Which is your preffered payment 
                                                method:
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                </asp:Label>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <asp:Panel ID="pnlMessage" runat="server" CssClass="" Width="450px" BackColor="#F4F4F4"
                    Height="260px">
                    <div class="" style="padding: 0px;  background-color: #17529B;
