<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChangePassword.aspx.cs" Inherits="EPolicy.ChangePassword" %>
                        ...
                        <asp:button id="BtnExit" runat="server" Text="EXIT"
                         ...
                         <div class="row formWraper" style="padding: 0px;" align="center">
                            ...
                            <div align="center" style="background-color:Gray;height:35px">
                                <asp:Label id="Label1" runat="server" Font-Bold="True" ForeColor="White">Change Password</asp:Label>                   
                            </div>
                                <br />
                              <asp:label id="lblusername" RUNAT="server" CssClass="labelForControl">User Name:</asp:label>
								<br />
                                <br />
                                <asp:TextBox ID="TxtUserName" Enabled="false" runat="server" CssClass="form-controlWhite" 
                                   TabIndex="1004" Width="300px"></asp:TextBox>
                                <br />
                                <br />		
                                <asp:label id="Label3" RUNAT="server" CssClass="labelForControl">Old Password:</asp:label>
								<br />
                                <br />
                                <asp:TextBox ID="TxtPassword" runat="server" CssClass="form-controlWhite" 
                                   TabIndex="1004" Width="300px" TextMode="Password"></asp:TextBox>
                                <br />
                                <br />
                                <asp:label id="Label4" RUNAT="server" CssClass="labelForControl">New Password:</asp:label>
								<br />
                                <br />
                                <asp:TextBox ID="TxtNewPassword" runat="server" CssClass="form-controlWhite" 
                                   TabIndex="1004" Width="300px" TextMode="Password"></asp:TextBox>
                                <br />
                                <br />
                                <asp:label id="Label5" RUNAT="server" CssClass="labelForControl">Confirm Password:</asp:label>
								<br />
                                <br />
                                <asp:TextBox ID="TxtConfirmPassword" runat="server" CssClass="form-controlWhite" 
                                   TabIndex="1004" Width="300px" TextMode="Password"></asp:TextBox>
                                <br />
                                <br />
                                <br />
