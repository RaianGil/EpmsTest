                ...
                <div class="row row-offcanvasrow-offcanvas-left" style="height: 100%">
                    ...
                    <div class="col-sm-9 col-md-10 main" style="height: 100%">
                        ...
                        <div class="form=group" align="center">
                            <asp:Button ID="btnBack" runat="server" Text="EXIT" Width="155px" CssClass="btn btn-primary btn-lg"
                                OnClick="btnBack_Click"></asp:Button>
                            <br />
                            <br />
                            <div align="left">
                                <asp:Label ID="lblHeading" runat="server" Font-Bold="True" ForeColor="Gray"></asp:Label>
                            </div>
                        </div>
                        <div class="form-group" align="center">
                        ...
                        <div class="row formWraper" style="padding: 0px;" align="center">
                            ...
                            <div class="table-responsive">
                                <asp:DataGrid ID="grdAuditItems" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                            CellPadding="0" 
                                    HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="center"
                                            Font-Bold="True" Font-Size="14px" BorderColor="Transparent"  
                                    PageSize="15" Width="80%" CssClass="table table-striped" 
                                    OnItemCommand="grdAuditItems_ItemCommand" 
                                    onpageindexchanged="grdAuditItems_PageIndexChanged">
                                    ...
                                    <Columns>
                                       <asp:ButtonColumn ButtonType="LinkButton" HeaderStyle-HorizontalAlign="Center" CommandName="Select" Text="&lt;img src='images2/searchGrid.png' width='26px' height='30px' &gt;"
                                        ...
                                        <asp:BoundColumn DataField="KeyID" HeaderText="Control ID">
                           ...
                           <div class="col-sm-12" align="center">
                                <asp:Label ID="Label2" Height="18" runat="server" EnableViewState="False" Visible="false">Notes:</asp:Label><asp:TextBox
                                    ID="TxtNotes" runat="server" TextMode="MultiLine" Height="275px" Width="700px" Enabled="False" CssClass="form-controlWhite"></asp:TextBox>
