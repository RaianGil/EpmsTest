...
{
    public class DoubleInterest : Policy
    {
        public DoubleInterest(bool isQuote)
        {
            ...
            if (this.isQuote)
                this.TaskControlTypeID = int.Parse(LookupTables.LookupTables.GetID("TaskControlType", "Double Interest Policy Quote"));
            else
            {
                this.DepartmentID = 1;
                this.TaskControlTypeID = int.Parse(LookupTables.LookupTables.GetID("TaskControlType", "Double Interest Policy"));
            }
        ...
        private DataTable _VehicleBreakDownCollection = null;

        private int _VehicleID = 0;
        private DataTable _dtDoubleInterest;
        ...
        public DataTable VehicleBreakDownCollection
        {
            get
            {
                if (this._VehicleBreakDownCollection == null)
                    this._VehicleBreakDownCollection = DataTableVehicleBreakDownTemp();
                return (this._VehicleBreakDownCollection);
            }
            set
            {
                this._VehicleBreakDownCollection = value;
            }
        }
        ...
        public void SaveAutos(int UserID)
        {
            ...
            this.SaveVehicleBreakDown(UserID, this.TaskControlID);
        }
        ...
        public static DoubleInterest GetDoubleInterest(int TaskControlID, bool isQuote)
        {
            DoubleInterest autos = null;

            DataTable dt = GetAutosByTaskControlIDDB(TaskControlID, isQuote);

            autos = new DoubleInterest(isQuote);

            if (isQuote)
                autos = (DoubleInterest)Policy.GetPolicyQuoteByTaskControlID(TaskControlID, autos);  //PolicyQuote
            else
                autos = (DoubleInterest)Policy.GetPolicyByTaskControlID(TaskControlID, autos);  //Policy

            autos._dtDoubleInterest = dt;
        ...
        private void SaveAutosDB()
        {
            ...
            try
            {
                ...
                {
                    case 1:  //ADD
                        this.AutosID = Executor.Insert("AddAutosDoubleInterest", this.GetInsertAutosXml());
        ...
        private XmlDocument GetInsertAutosXml()
        {
            ...
            DbRequestXmlCooker.AttachCookItem("Terms",
              SqlDbType.VarChar, 50, this.Terms.ToString(),
              ref cookItems);
        ...
        private static DoubleInterest FillProperties(DoubleInterest autos, int taskControlID, bool isQuote)
        {
            try
            {
                autos.TaskControlID = int.Parse(autos._dtDoubleInterest.Rows[0]["TaskControlID"].ToString());
                autos.PolicyClaim = autos._dtDoubleInterest.Rows[0]["PolicyClaim"].ToString();
                autos.RenewalNo = autos._dtDoubleInterest.Rows[0]["RenewalNo"].ToString();
                autos.CustomerCollection = autos._dtDoubleInterest.Rows[0]["CustomerCollection"].ToString();
                autos.TrafficViolationPoints = int.Parse(autos._dtDoubleInterest.Rows[0]["TrafficViolationPoints"].ToString());
                autos.TrafficViolationSurcharge = double.Parse(autos._dtDoubleInterest.Rows[0]["TrafficViolationSurcharge"].ToString());
                autos.UnderageSurcharge = double.Parse(autos._dtDoubleInterest.Rows[0]["UnderageSurcharge"].ToString());
                autos.isBusinessPolicy = bool.Parse(autos._dtDoubleInterest.Rows[0]["isBusiness"].ToString());
                autos.TotalDiscounts = double.Parse(autos._dtDoubleInterest.Rows[0]["TotalDiscounts"].ToString());
                autos.TotalDiscountsPct = double.Parse(autos._dtDoubleInterest.Rows[0]["TotalDiscountsPct"].ToString());
                autos.AnyAccidentsOrLosses = bool.Parse(autos._dtDoubleInterest.Rows[0]["AnyAccidentsOrLosses"].ToString());
                autos.YearsWithNoClaims = autos._dtDoubleInterest.Rows[0]["YearsWithNoClaims"].ToString();
                autos.AnyDriverUnder26 = bool.Parse(autos._dtDoubleInterest.Rows[0]["AnyDriverUnder26"].ToString());
                autos.Q1 = bool.Parse(autos._dtDoubleInterest.Rows[0]["Q1"].ToString());
                autos.Q2 = bool.Parse(autos._dtDoubleInterest.Rows[0]["Q2"].ToString());
                autos.Q3 = bool.Parse(autos._dtDoubleInterest.Rows[0]["Q3"].ToString());
                autos.EffectiveDateApp = autos._dtDoubleInterest.Rows[0]["EffectiveDate"].ToString();
                autos.ExpirationDateApp = autos._dtDoubleInterest.Rows[0]["ExpirationDate"].ToString();
                autos.UseCompanyAsNamedInsured = bool.Parse(autos._dtDoubleInterest.Rows[0]["UseCompanyAsNamedInsured"].ToString());
                autos.IsNewCustomer = bool.Parse(autos._dtDoubleInterest.Rows[0]["IsNewCustomer"].ToString());
                autos.YearsWithClaims = autos._dtDoubleInterest.Rows[0]["YearsWithClaims"].ToString();
                autos.Surcharge = autos._dtDoubleInterest.Rows[0]["Surcharge"].ToString() != "" ? double.Parse(autos._dtDoubleInterest.Rows[0]["Surcharge"].ToString()) : 0.0;
                autos.SurchargePct = autos._dtDoubleInterest.Rows[0]["SurchargePct"].ToString() != "" ? double.Parse(autos._dtDoubleInterest.Rows[0]["SurchargePct"].ToString()) : 0.0;
                autos.Terms = autos._dtDoubleInterest.Rows[0]["Terms"].ToString();
                autos.AffinityDiscount = autos._dtDoubleInterest.Rows[0]["AffinityDiscount"].ToString() != "" ? double.Parse(autos._dtDoubleInterest.Rows[0]["AffinityDiscount"].ToString()) : 0.0;
                autos.AffinityDiscountPct = autos._dtDoubleInterest.Rows[0]["AffinityDiscountPct"].ToString() != "" ? double.Parse(autos._dtDoubleInterest.Rows[0]["AffinityDiscountPct"].ToString()) : 0.0;
                autos.GrossTax = autos._dtDoubleInterest.Rows[0]["GrossTax"].ToString() != "" ? double.Parse(autos._dtDoubleInterest.Rows[0]["GrossTax"].ToString()) : 0.0;
                ...
                autos.VehicleBreakDownCollection = GetVehicleBreakDownByTaskControlID(taskControlID, isQuote);
        ...
        public void SaveVehicleBreakDown(int UserID, int taskControlID)
        {
            DBRequest Executor = new DBRequest();
            Executor.Update("DeleteVehicleBreakDownByTaskControlID", DeleteVehiclesBreakDownByTaskControlIDXml(taskControlID));

            for (int i = 0; i < VehicleBreakDownCollection.Rows.Count; i++)
            {
                this.Mode = 1; //Add

                Executor.BeginTrans();
                this.VehicleID = Executor.Insert("AddVehicleBreakDown", this.GetInsertVehicleBreakDownXml(i));
                Executor.CommitTrans();
            }
        }
        ...
        private XmlDocument DeleteVehiclesBreakDownByTaskControlIDXml(int taskControlID)
        {
            DbRequestXmlCookRequestItem[] cookItems = new DbRequestXmlCookRequestItem[2];
        ...
        private XmlDocument GetInsertVehicleBreakDownXml(int index)
        {
            DbRequestXmlCookRequestItem[] cookItems = new DbRequestXmlCookRequestItem[49];

            DbRequestXmlCooker.AttachCookItem("VehicleDetailID",
              SqlDbType.Int, 0, VehicleBreakDownCollection.Rows[index]["VehicleDetailID"].ToString(),
              ref cookItems);

            DbRequestXmlCooker.AttachCookItem("VehicleBreakDownID",
           SqlDbType.Int, 0, VehicleBreakDownCollection.Rows[index]["VehicleBreakDownID"].ToString(),
           ref cookItems);
            ...
            DbRequestXmlCooker.AttachCookItem("VehicleYear",
              SqlDbType.Int, 0, VehicleBreakDownCollection.Rows[index]["VehicleYear"].ToString(),
              ref cookItems);

            DbRequestXmlCooker.AttachCookItem("VehicleMake",
            SqlDbType.VarChar, 50, VehicleBreakDownCollection.Rows[index]["VehicleMake"].ToString(),
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("VehicleModel",
            SqlDbType.VarChar, 50, VehicleBreakDownCollection.Rows[index]["VehicleModel"].ToString(), //5
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("VIN",
            SqlDbType.VarChar, 20, VehicleBreakDownCollection.Rows[index]["VIN"].ToString(),
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("LicensePlateNo",
            SqlDbType.VarChar, 20, VehicleBreakDownCollection.Rows[index]["LicensePlateNo"].ToString(),
            ref cookItems);
            ...
            DbRequestXmlCooker.AttachCookItem("Island",
            SqlDbType.VarChar, 30, VehicleBreakDownCollection.Rows[index]["Island"].ToString(),
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("Status",
            SqlDbType.VarChar, 30, VehicleBreakDownCollection.Rows[index]["Status"].ToString(), //10
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("VehicleValue",
            SqlDbType.VarChar, 30, VehicleBreakDownCollection.Rows[index]["VehicleValue"].ToString(),
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("VehicleUse",
            SqlDbType.VarChar, 30, VehicleBreakDownCollection.Rows[index]["VehicleUse"].ToString(),
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("PassengersNo",
            SqlDbType.Int, 0, VehicleBreakDownCollection.Rows[index]["PassengersNo"].ToString(),
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("Over2Tons",
            SqlDbType.Bit, 0, VehicleBreakDownCollection.Rows[index]["Over2Tons"].ToString(),
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("MedicalPayment",
            SqlDbType.Bit, 0, VehicleBreakDownCollection.Rows[index]["MedicalPayment"].ToString(), //15
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("MotoristCoverage",
            SqlDbType.Bit, 0, VehicleBreakDownCollection.Rows[index]["MotoristCoverage"].ToString(),
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("RentalReimCoverage",
            SqlDbType.Bit, 0, VehicleBreakDownCollection.Rows[index]["RentalReimCoverage"].ToString(),
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("DeathDismembermentCoverage",
            SqlDbType.Bit, 0, VehicleBreakDownCollection.Rows[index]["DeathDismembermentCoverage"].ToString(),
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("ViolationPoints",
            SqlDbType.VarChar, 30, VehicleBreakDownCollection.Rows[index]["ViolationPoints"].ToString(),
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("ViolationSurcharge",
            SqlDbType.VarChar, 30, VehicleBreakDownCollection.Rows[index]["ViolationSurcharge"].ToString(),
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("UnderAgeSurcharge",
            SqlDbType.VarChar, 30, VehicleBreakDownCollection.Rows[index]["UnderAgeSurcharge"].ToString(), //20
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("OtherSurcharge",
            SqlDbType.VarChar, 30, VehicleBreakDownCollection.Rows[index]["OtherSurcharge"].ToString(), //20
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("OtherSurchargePct",
            SqlDbType.Float, 0, VehicleBreakDownCollection.Rows[index]["OtherSurchargePct"].ToString(), //20
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("PDLimit",
            SqlDbType.VarChar, 30, VehicleBreakDownCollection.Rows[index]["PDLimit"].ToString(),
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("ComprehensiveDedu",
            SqlDbType.VarChar, 30, VehicleBreakDownCollection.Rows[index]["ComprehensiveDedu"].ToString(),
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("CollisionDedu",
            SqlDbType.VarChar, 30, VehicleBreakDownCollection.Rows[index]["CollisionDedu"].ToString(),
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("BIPPLimit",
            SqlDbType.VarChar, 30, VehicleBreakDownCollection.Rows[index]["BIPPLimit"].ToString(),
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("BIPOLimit",
            SqlDbType.VarChar, 30, VehicleBreakDownCollection.Rows[index]["BIPOLimit"].ToString(), //25
            ref cookItems);

            //
            DbRequestXmlCooker.AttachCookItem("MPLimit",
            SqlDbType.VarChar, 30, VehicleBreakDownCollection.Rows[index]["MPLimit"].ToString(), //25
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("CompPremium",
            SqlDbType.Float, 0, VehicleBreakDownCollection.Rows[index]["CompPremium"].ToString(), //25
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("CollPremium",
            SqlDbType.Float, 0, VehicleBreakDownCollection.Rows[index]["CollPremium"].ToString(), //25
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("BIPremium",
            SqlDbType.Float, 0, VehicleBreakDownCollection.Rows[index]["BIPremium"].ToString(), //25
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("PDPremium",
            SqlDbType.Float, 0, VehicleBreakDownCollection.Rows[index]["PDPremium"].ToString(), //25
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("MPPremium",
            SqlDbType.Float, 0, VehicleBreakDownCollection.Rows[index]["MPPremium"].ToString(), //25
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("MotoristPremium",
            SqlDbType.Float, 0, VehicleBreakDownCollection.Rows[index]["MotoristPremium"].ToString(), //25
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("RentalReim",
            SqlDbType.Float, 0, VehicleBreakDownCollection.Rows[index]["RentalReim"].ToString(), //25
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("ADDPremium",
            SqlDbType.Float, 0, VehicleBreakDownCollection.Rows[index]["ADDPremium"].ToString(), //25
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("TotalPremium",
            SqlDbType.Float, 0, VehicleBreakDownCollection.Rows[index]["TotalPremium"].ToString(), //25
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("BankDesc",
            SqlDbType.VarChar, 50, VehicleBreakDownCollection.Rows[index]["BankDesc"].ToString(), //25
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("BankPPSID",
            SqlDbType.VarChar, 10, VehicleBreakDownCollection.Rows[index]["BankPPSID"].ToString(), //25
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("IsMotorcycleScooter",
            SqlDbType.Bit, 0, VehicleBreakDownCollection.Rows[index]["IsMotorcycleScooter"].ToString(),
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("TaxiLossAmount",
            SqlDbType.Float, 0, VehicleBreakDownCollection.Rows[index]["TaxiLossAmount"].ToString(),
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("VehicleRowNumber",
           SqlDbType.Int, 0, VehicleBreakDownCollection.Rows[index]["VehicleRowNumber"].ToString(),
           ref cookItems);
            ...
            DbRequestXmlCooker.AttachCookItem("IsHeavyTruck",
            SqlDbType.Bit, 0, VehicleBreakDownCollection.Rows[index]["IsHeavyTruck"].ToString(),
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("NewUse",
            SqlDbType.Int, 0, VehicleBreakDownCollection.Rows[index]["NewUse"].ToString(),
            ref cookItems);

            DbRequestXmlCooker.AttachCookItem("IsSalvage",
            SqlDbType.Bit, 0, VehicleBreakDownCollection.Rows[index]["IsSalvage"].ToString(),
            ref cookItems);
        ...
        private static DataTable GetVehicleBreakDownByTaskControlIDDB(int taskControlID, bool isQuote)
        {
            DbRequestXmlCookRequestItem[] cookItems =
                new DbRequestXmlCookRequestItem[2];
            ...
            DataTable dt = exec.GetQuery("GetVehicleBreakDownByTaskControlID", xmlDoc);

            return dt;
        }

        public static DataTable GetVehicleBreakDownByTaskControlID(int TaskControlID, bool isQuote)
        {
            DataTable dt = GetVehicleBreakDownByTaskControlIDDB(TaskControlID, isQuote);
            return dt;
        }
        ...
        private DataTable DataTableVehicleBreakDownTemp()
        {
            DataTable myDataTable = new DataTable("DataTableVehicleBreakDownTemp");
            DataColumn myDataColumn;

            myDataColumn = new DataColumn();
            myDataColumn.DataType = System.Type.GetType("System.Int32");
            myDataColumn.ColumnName = "VehicleBreakDownID";
            myDataColumn.AutoIncrement = true;
            myDataColumn.AutoIncrementSeed = 1;
            myDataColumn.AutoIncrementStep = 1;
            myDataColumn.AllowDBNull = false;
            ...
            myDataColumn.ColumnName = "VehicleDetailID";
            myDataColumn.AutoIncrement = false;
            myDataColumn.Caption = "VehicleDetailID";
            myDataColumn.ReadOnly = false;
            myDataColumn.Unique = false;
            myDataTable.Columns.Add(myDataColumn);
        ...
        public DataTable GetAutosQuoteCount(string TaskControlID)
        {
            DataTable dt = null;
           DbRequestXmlCookRequestItem[] cookItems = new DbRequestXmlCookRequestItem[1];
           DbRequestXmlCooker.AttachCookItem("TaskControlID", SqlDbType.Int, 0, TaskControlID.Trim(), ref cookItems);
                ...
                dt = exec.GetQuery("GetAutosQuoteCount", xmlDoc);
                return dt;
            
        }

        public DataTable GetAutosPolizaCount(string TaskControlID)
        {
            DataTable dt = null;
            DbRequestXmlCookRequestItem[] cookItems = new DbRequestXmlCookRequestItem[1];
            DbRequestXmlCooker.AttachCookItem("TaskControlID", SqlDbType.Int, 0, TaskControlID.Trim(), ref cookItems);
            ...
            dt = exec.GetQuery("GetAutosPolizaCount", xmlDoc);
            return dt;
