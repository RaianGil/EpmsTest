                ...
                <div class="row row-offcanvasrow-offcanvas-left" style="height: 100%">
                    ...
                    <div class="col-sm-9 col-md-10 main" style="height: 100%">
                        ...
                        <h1 class="page-header">
                            Lookup Table Description</h1>
                        <div class="form=group" align="center">
                            <asp:Button ID="btnSearch" runat="server" Text="SEARCH" Width="155px" CssClass="btn btn-primary btn-lg"
                                OnClick="btnSearch_Click"></asp:Button>
                            <asp:Button ID="btnClear" runat="server" Text="CLEAR" Width="155px" CssClass="btn btn-primary btn-lg"
                                OnClick="btnClear_Click"></asp:Button>
                            <asp:Button ID="btnAddNew" runat="server" Text="ADD" Width="155px" CssClass="btn btn-primary btn-lg"
                            ...
                            <br />
                            <div align="left">
                                <asp:Label ID="lblSearchX" runat="server" Font-Bold="True" ForeColor="Gray">Search lookup table:</asp:Label>
                            </div>
                        </div>
                        <div class="form-group" align="center">
                        ...
                        <div class="row formWraper" style="padding: 0px;" align="center">
                            <div class="col-sm-12" align="center">
                                <br />
                                <asp:Label ID="Label1" CssClass="labelForControl" runat="server" Text="Other Tables"></asp:Label>
                                <br />
                                <asp:DropDownList ID="ddlLookupTables" TabIndex="3" runat="server" AutoPostBack="True"
                                    OnSelectedIndexChanged="ddlLookupTables_SelectedIndexChanged" CssClass="form-controlWhite"
                                    Width="300px">
                                </asp:DropDownList>
                                <br />
                                <br />
                                <asp:Label ID="lblSearchFieldA" CssClass="labelForControl" runat="server"></asp:Label>
                                <br />
                                <asp:TextBox ID="txtSearchFieldA" TabIndex="1" runat="server" MaxLength="15" CssClass="form-controlWhite"
                                    Width="300px"></asp:TextBox>
                                <br />
                                <br />
                                <asp:Label ID="lblSearchFieldB" CssClass="labelForControl" runat="server"></asp:Label>
                                <br />
                                <asp:TextBox ID="txtSearchFieldB" TabIndex="2" runat="server" MaxLength="15" CssClass="form-controlWhite"
                                    Width="300px"></asp:TextBox>
                                <br />
                                <br />
                                ...
                                <br />
                                 <br />
                                  ...
                                  <div align="left" style="padding-left:120px">
                                    <asp:Label ID="lblTotalRecords" runat="server" CssClass="h2 sub-header" ForeColor="#17529B">Total Records:</asp:Label>
                                    <asp:Label ID="LblError" runat="server" ForeColor="Red" Visible="False">Label</asp:Label>
                                </div>        
                                  <br />
                                <br />
                                <div class="table-responsive">
                                    <asp:DataGrid ID="grdRecords" BorderWidth="1px" BorderStyle="Solid"
                                        CssClass="tableMain" runat="server"  ItemStyle-CssClass="HeadForm3"
                                        HeaderStyle-BackColor="#5C8BAE" HeaderStyle-CssClass="HeadForm2" AlternatingItemStyle-BackColor="#FEFBF6"
                                        AlternatingItemStyle-CssClass="HeadForm3" CellPadding="0"
                                        AllowPaging="True" AutoGenerateColumns="False" BackColor="White" HeaderStyle-HorizontalAlign="Center"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:ButtonColumn ButtonType="PushButton" HeaderText="Modify" CommandName="Select">
