                ...
                <div class="row row-offcanvasrow-offcanvas-left" style="height: 100%">
                    ...
                    <div class="col-sm-9 col-md-10 main" style="height: 100%">
                        ...
                        <h1 class="page-header">
                            Table Maintenance</h1>
                            <div class="form=group" align="center">
                             <asp:Button id="btnPrint" runat="server" Text="Print List" 
                                    onclick="btnPrint_Click" Width="155px" CssClass="btn btn-primary btn-lg" 
                                    Visible="False"></asp:Button>
			                <asp:Button id="cmdExit" runat="server" Text="Exit" Width="155px" CssClass="btn btn-primary btn-lg" onclick="cmdExit_Click"></asp:Button>
                            <br />
                            <br />
                            <div align="left">
                        ...
                        <div class="form-group" align="center">
                         ...
                         <div class="row formWraper" style="padding: 0px;" align="center">
                            <div class="col-sm-12" align="center">
                                <br />
                                <asp:label id="LblTotalCases" RUNAT="server"  CssClass="labelForControl">Table:</asp:label>
                                <asp:DropDownList id="ddlLookupTables" tabIndex="1" CssClass="form-controlWhite" Width="300px" runat="server" AutoPostBack="True" onselectedindexchanged="ddlLookupTables_SelectedIndexChanged"></asp:DropDownList>
                                 <br />
                                  <img alt="" src="Images2/GreyLine.png" style="height: 6px; margin-top: 0px;" width="85%;" />
                                <br />
                                <div class="table-responsive">
                                <asp:datagrid id="grdDisplayDescriptions" RUNAT="server" 
                                        CssClass="table table-striped" PageSize="12" ITEMSTYLE-CSSCLASS="HeadForm3"
                                 HEADERSTYLE-BACKCOLOR="#5C8BAE" HEADERSTYLE-CSSCLASS="HeadForm2" ALTERNATINGITEMSTYLE-BACKCOLOR="#FEFBF6" 
                                        ...
                                        Width="80%">
																		...
																		<AlternatingItemStyle HorizontalAlign="Center" 
                                                                            BackColor="#EBEBEB" Font-Bold="False" Font-Italic="False" Font-Overline="False" 
                                                                            Font-Strikeout="False" Font-Underline="False"></AlternatingItemStyle>
																		<ItemStyle HorizontalAlign="Center" 
                                                                            Font-Bold="False" Font-Italic="False" Font-Overline="False" 
                                                                            Font-Strikeout="False" Font-Underline="False" BorderColor="#EBEBEB"></ItemStyle>
																		<HeaderStyle HorizontalAlign="Center" ForeColor="White"
																			BackColor="Gray" Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False"></HeaderStyle>
																		<Columns>
																		...
																		<PagerStyle HorizontalAlign="Left" ForeColor="Gray" BackColor="White" PageButtonCount="20"
																			CssClass="Numbers" Mode="NumericPages" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" 
                                               ...
                                               <br />
                                                 ...
                                                 <div class="form=group" align="center">
<asp:label id="lblInput"  RUNAT="server" Visible="False"  CssClass="labelForControl">New:</asp:label>
<asp:TextBox id="txtInput" tabIndex="3" runat="server" Visible="False" MaxLength="50" CssClass="form-controlWhite" Width="300px"></asp:TextBox>
 <asp:CheckBox ID="chkMotorcycle" runat="server" Text="Is Motorcycle" 
                                                            Visible="False" />

                                                     &nbsp;<asp:Button id="cmdCancel" runat="server" Text="Cancel" Width="155px" CssClass="btn btn-primary btn-lg" onclick="cmdCancel_Click"></asp:Button>
														&nbsp;<asp:Button id="cmdAdd" runat="server" Width="155px" CssClass="btn btn-primary btn-lg" Text="Add" onclick="cmdAdd_Click"></asp:Button>
														&nbsp;<asp:Button id="cmdSave" runat="server" Width="155px" CssClass="btn btn-primary btn-lg" Text="Save" onclick="cmdSave_Click"></asp:Button>
                                                        <br />
                                <br />
                                <br />
                                <br />
