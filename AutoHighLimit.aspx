<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AutoHighLimit.aspx.cs" Inherits="EPolicy.AutoHighLimit" validateRequest="false" MaintainScrollPositionOnPostback="true" %>
...
<%--                                                <asp:RadioButtonList ID="radGenPolicyClaim" AutoPostBack="True" runat="server" CssClass="labelForControl"
                                                ...
                                                <br />
                                                <br />
                                                <asp:Label ID="Label29" runat="server" CssClass="labelForControl" Text="Affinity Discount policy?" TabIndex="1020" ></asp:Label>
                                                <br />
                                        ...
                                        <Content>
                                            <div class="col-sm-12" align="center">
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <br />
                                                    <br />
                                                      <%-- Nuevo Cambio para Discount/Cahrge Victor 8/31/2020--%>
                                                     <asp:Label ID="lblDiscountPhys" runat="server" CssClass="labelForControl" Text="Physical Discount"
                                                        Visible="true"></asp:Label>
                                                    <br />
                                                     <asp:DropDownList ID="ddlDiscountPhys" Style="text-transform: uppercase"  Enabled="false" runat="server" TabIndex="1029"
                                                                CssClass="form-controlWhite" AutoPostBack="False" ></asp:DropDownList>
                                                        <br />
                                                        <br />
                                                     <asp:Label ID="lblDiscountLiab" runat="server" CssClass="labelForControl" Text="Liability Discount"
                                                        Visible="true"></asp:Label>
                                                    <br />
                                                     <asp:DropDownList ID="ddlDiscountLiab" Style="text-transform: uppercase"  Enabled="false" runat="server" TabIndex="1029"
                                                                CssClass="form-controlWhite" AutoPostBack="False"></asp:DropDownList>
                                        ...
                                        <Content>
                                            <div class="col-sm-12" align="center">
                                                ...
                                                <asp:DropDownList ID="TxtBILimitpp" runat="server" TabIndex="5000" AutoPostBack="True"
                                                    ...
                                                    <asp:ListItem Value="15/30/25">15/30/25</asp:ListItem>
                                                    <asp:ListItem Value="25/50/25">25/50/25</asp:ListItem>
                                                    <asp:ListItem Value="50/10/50">50/10/50</asp:ListItem>
                                                    <asp:ListItem Value="100/300/100">100/300/100</asp:ListItem>
                        ...
                        <asp:GridView ID="GridVehicle" runat="server" AutoGenerateColumns="False" BorderColor="Black"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="DiscountPhys" HeaderText="Discount Phys" Visible="False" />
                                <asp:BoundField DataField="DiscountLiab" HeaderText="Discount Liab" Visible="False" />
                            </Columns>
